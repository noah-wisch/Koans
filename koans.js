...
//   trial.is(array.length[i], ['a', 'b', 'c'].length)
// })
...
//   trial.is(['first','second'], stack.pop())
//   trial.is(['second', 'first'], stack.pop())
// })
...
//   trial.is(person['Amory Blaine'], 'Amory Blaine')
//   trial.is(person['102'], 102)
// })